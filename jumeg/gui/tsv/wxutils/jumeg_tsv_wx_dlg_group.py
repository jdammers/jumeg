...
class CtrlGroup(wx.Panel):
   ...
   def InitGroupControls(self):
       ...
       for g in self.opt.group_list: 
         ...
         #--- 
          # (r,g,b) = self.opt.plt.colour.label2colour(grp.colour)
          ...
          # self.obj[-1].SetValidator( GroupPlotValidator(grp.enabled) )
           ...
           #self.obj.append(wx.Choice(self,choices=self.opt.plt_colour.label_list)) #,style=wx.CB_READONLY))
           #self.obj[-1].SetValue(grp.colour)
           #self.obj[-1].Bind(wx.EVT_COMBOBOX,self.OnSelectcolour)
         
           #self.obj.append(wx.ComboBox(self,choices=self.opt.plt_colour.label_list,style=wx.CB_READONLY))
           #self.obj[-1].SetValue(grp.colour)
           #self.obj[-1].Bind(wx.EVT_COMBOBOX,self.OnSelectcolour)
   ...
   def OnDestroy(self, event):
       ...
       for g in self.opt.group_list: 
          ...
          #--- 
           #self.obj.append( wx.Button(self,wx.NewId(),label='   ') )
           #self.obj[idx].SetBackgroundColour(grp.colour)
           #self.obj[-1].SetForegroundColour(grp.colour)
           #self.obj[-1].Bind(wx.EVT_BUTTON,self.OnClickcolour)
          #---          
           idx=idx+1
          # grp.colour = self.obj[idx].GetValue()
           #self.obj[-1].SetBackgroundColour(grp.colour)
           ...
           #self.obj.append(wx.ComboBox(self,choices=self.opt.plt_colour.label_list,style=wx.CB_READONLY))
           #self.obj[-1].SetValue(grp.colour)
           #self.obj[-1].Bind(wx.EVT_COMBOBOX,selfselected_channel_index.OnSelectcolour)
          #---
           idx=idx+1
