...
def init_logfile(logger=None,fname=None,overwrite=True,prefix=None,path="./log",name=None,level=None):
    """
    Parameters
    ----------
    logger
    ...
    Hlog = update_filehandler(logger=logger,fname=fname,path=path,prefix=prefix,name=name,mode=mode,level=level)
    return Hlog
