...
def apply_noise_reducer(raw_fname,raw=None,**cfg):
   ...
   #--- catch stdout,stderr
    jumeg_logger.log_stdout()  #StreamLoggerSTDOUT(level=logging.DEBUG)

    #sys.stdout = jumeg_logger.STDStreamLogger(level=logging.DEBUG)
    # sys.stderr = jumeg_logger.STDStreamLogger(logger,logging.ERROR)
