...
#
##################################################
def perform_detrending(fname_raw,raw=None, save=True,verbose=False):
...
def noise_reducer(fname_raw,raw=None,signals=[], noiseref=[], detrending=None,
    ...
    """
       ...
       # read raw data in
        ...
        if detrending:
           raw = perform_detrending(fname_raw,raw=raw,save=False,verbose=verbose)
        ...
        if save:
           ...
           if not fnout:
              fnout = fname_raw[:fname_raw.rfind('-raw.fif')] + ',n-raw.fif'
